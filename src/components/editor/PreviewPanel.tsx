...
import { Layers, Target, BookOpen, AlertCircle, HelpCircle, GraduationCap, CheckSquare, Info, ExternalLink } from 'lucide-react';
        ...
        <div className="flex justify-between items-start">
          <div className="space-y-1">
            ...
            <p className="uppercase tracking-[0.3em] text-[10px] font-black text-brand-primary flex items-center gap-2">
              ...
              Instructional Tier: {data.rigorLevel || 'Standard'}
            </p>
          </div>
                ...
                <div className="flex flex-wrap gap-1">
                   {mod.standards?.map((s: string) => (
                     <Popover key={s}>
                       ...
                       <PopoverContent className="bg-brand-black text-white border-none shadow-none text-xs p-4 w-72 rounded-none">
